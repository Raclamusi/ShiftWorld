...
void Main()
{
	...
	LicenseManager::AddLicense(LicenseInfo
		{
			.title = U"DotGothic16",
			.copyright = U"Copyright 2020 The DotGothic16 Project Authors (https://github.com/fontworks-fonts/DotGothic16)",
			.text = Unicode::WidenAscii(R"(This Font Software is licensed under the SIL Open Font License, Version 1.1.
...
OTHER DEALINGS IN THE FONT SOFTWARE.
	...
	FontAsset::Register(U"Title", FontMethod::MSDF, 48, Resource(U"example/font/DotGothic16/DotGothic16-Regular.ttf"), FontStyle::Bitmap);
